...
dpst.DPST_MODEL_PATH = dpst._LOCAL_MODEL_DIR / "dhh_classifier_v25_synth.pt"
dpst.DPST_META_PATH  = dpst._LOCAL_MODEL_DIR / "dpst_model_meta_v25.json"
...
print(f"\n== v25 SYNTHETIC-ONLY | REAL DHH CORPUS: {n} tracks, accuracy {acc:.1%} ==")
hdr="true/pred"
